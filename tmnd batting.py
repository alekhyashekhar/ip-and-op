...
# Read inputs
X = int(input())  # Salary of senior players in rupees
Y = int(input())  # Salary of junior players in rupees

# Calculate contributions
senior_players = 6
junior_players = 5

# Contribution from senior players (50% of salary)
senior_contribution = senior_players * (0.5 * X)

# Contribution from junior players (40% of salary)
junior_contribution = junior_players * (0.4 * Y)
