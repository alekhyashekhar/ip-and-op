...
'''
# Read inputs
x1 = int(input())  # x-coordinate of the first vertex
y1 = int(input())  # y-coordinate of the first vertex
x2 = int(input())  # x-coordinate of the second vertex
y2 = int(input())  # y-coordinate of the second vertex
x3 = int(input())  # x-coordinate of the third vertex
y3 = int(input())  # y-coordinate of the third vertex
